 ...
 */
Delegate.prototype.root = function(rootElement) {
	'use strict';
	...
	for (eventType in listenerMap) {
		if (listenerMap.hasOwnProperty(eventType)) {
			rootElement.addEventListener(eventType, this.handle, this.captureForType(eventType));
		}
	}
};
