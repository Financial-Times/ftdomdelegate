...
Delegate.prototype.once = function (eventType, selector, handler, useCapture) {
  var delegate = this;
  ...
  var callback = function () {
    ...
    delegate.off(eventType, selector, callback, useCapture);
  };

  this.on(eventType, selector, callback, useCapture);

  return callback; // so that off can be called and passed the callback
};
